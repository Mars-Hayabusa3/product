...
$row = $pdo->query("SELECT * FROM `products_prac` WHERE sid=$sid")->fetch();
if (empty($row)) {
    header('Location: ab-list.php');
    exit;
}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pic" style="width:100%">
                        <img style="width:100%" src="./uploaded/<?= ($row['product_img']) ?>" id="myimg" alt="">
                    </div>

                    <form name="form1" onsubmit="sendData();return false;" novalidate>
                        <input type="hidden" name="photos" value="<?= $row['product_img'] ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select mb-3" aria-label="example" data-multiple id="category_sid" name="category_sid">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="product_desc" id="product_desc" cols="30" rows="5"><?= $row['product_desc'] ?></textarea>
...
<script>
    ...
    async function sendData() {
        ...
        // if (product_name_f.value.length < 3) {
        //     // alert('姓名至少兩個字');
        ...
        //     fieldTexts[0].innerText = '名稱至少兩個字';
        //     isPass = false;
        // }
